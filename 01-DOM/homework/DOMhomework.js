...
// Tu código acá:
document.querySelector("#createdBy"). innerHTML = "Aplicación creada por: Deras"
...
function buildToDos(toDos) {
  // Tu código acá:
  let nuevoArray = toDos.map((todo, index) => buildToDo(todo, index))
  return nuevoArray;
...
// Tu código acá:
let boton = document.querySelector("#addButton");
